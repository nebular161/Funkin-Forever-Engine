...
import gameplay.effects.WiggleEffect.WiggleEffectType;
...
import gameplay.editors.ChartingState;
import gameplay.editors.CharacterEditorState;
import flixel.group.FlxSpriteGroup;
import flixel.input.keyboard.FlxKey;
import gameplay.objects.Note.EventNote;
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("vcr.ttf"), 25, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK); //og number is 32
		...
		timeBar.createFilledBar(0xFF000000, 0xFF00FF9D);
	...
	if (ClientPrefs.watermark)
	{
		...
		scoreTxt.setFormat(Paths.font("vcr.ttf"), 15, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK); //og number is 20
	...
	override public function update(elapsed:Float)
	{
		...
		var percent:Float = 1 - (smoothHealth / 2);
